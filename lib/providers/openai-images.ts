...
function promptForRender(): string {
  return [
    ...
    "reimagined as a cute, chunky toy figurine seen from a 3/4 angle (front-left corner,",
    "slightly above eye level) so its front, one full side, and the top are all clearly visible.",
    "Preserve the drawing's exact proportions, silhouette, colors, and charming wonky character —",
    "it must clearly be the same car brought to life as a soft handmade toy, not a realistic vehicle.",
    "Give it real three-dimensional volume: rounded, slightly inflated, molded plastic / clay-like",
    "surfaces, lit with soft even studio lighting and gentle shading so the solid form reads clearly.",
